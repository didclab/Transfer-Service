...
public class DataInfluxConstants {
    ...
    public static final String PACKETS_SENT_DELTA = "packets_sent_delta";
    public static final String PACKETS_RECEIVED_DELTA = "packets_received_delta";
    ...
    public static final String P_METER_START_TIME = "pmeter_start_time";
