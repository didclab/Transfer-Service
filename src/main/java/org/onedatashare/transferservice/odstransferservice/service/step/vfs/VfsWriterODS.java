...
public class VfsWriterODS extends ODSBaseWriter implements ItemWriter<DataChunk>  {
    Logger logger = LoggerFactory.getLogger(VfsWriterODS.class);
    ...
    public VfsWriterODS(AccountEndpointCredential credential) {
