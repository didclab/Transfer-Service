...
public class SCPWriterODS extends ODSBaseWriter implements ItemWriter<DataChunk>, SetPool {

    private final EntityInfo fileInfo;
    Logger logger = LoggerFactory.getLogger(SCPWriterODS.class);
    ...
    public SCPWriterODS(EntityInfo fileInfo) {
