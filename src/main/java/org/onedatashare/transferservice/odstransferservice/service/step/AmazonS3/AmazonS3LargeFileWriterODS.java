...
public class AmazonS3LargeFileWriterODS extends ODSBaseWriter implements ItemWriter<DataChunk> {

    private final String bucketName;
    Logger logger = LoggerFactory.getLogger(AmazonS3LargeFileWriterODS.class);
    ...
    public AmazonS3LargeFileWriterODS(AccountEndpointCredential destCredential, EntityInfo fileInfo) {
