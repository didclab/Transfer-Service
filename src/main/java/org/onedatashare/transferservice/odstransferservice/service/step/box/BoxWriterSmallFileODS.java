...
public class BoxWriterSmallFileODS extends ODSBaseWriter implements ItemWriter<DataChunk> {
    ...
    Logger logger = LoggerFactory.getLogger(BoxWriterSmallFileODS.class);
    ...
    public BoxWriterSmallFileODS(OAuthEndpointCredential credential, EntityInfo fileInfo) {
