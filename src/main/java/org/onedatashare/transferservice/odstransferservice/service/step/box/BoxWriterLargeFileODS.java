 ...
 */
public class BoxWriterLargeFileODS extends ODSBaseWriter implements ItemWriter<DataChunk> {
    ...
    BoxFolder boxFolder;
    Logger logger = LoggerFactory.getLogger(BoxWriterLargeFileODS.class);
    ...
    public BoxWriterLargeFileODS(OAuthEndpointCredential oAuthDestCredential, EntityInfo fileInfo) {
