...
public class AmazonS3SmallFileWriterODS extends ODSBaseWriter implements ItemWriter<DataChunk> {

    private String fileName;
    private final EntityInfo fileInfo;
    private final AccountEndpointCredential destCredential;
    Logger logger = LoggerFactory.getLogger(AmazonS3SmallFileWriterODS.class);
    ...
    public AmazonS3SmallFileWriterODS(AccountEndpointCredential destCredential, EntityInfo fileInfo) {
