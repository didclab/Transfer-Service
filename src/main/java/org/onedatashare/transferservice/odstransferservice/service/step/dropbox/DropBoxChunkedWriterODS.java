...
public class DropBoxChunkedWriterODS extends ODSBaseWriter implements ItemWriter<DataChunk> {
    ...
    Logger logger = LoggerFactory.getLogger(DropBoxChunkedWriterODS.class);
    ...
    public DropBoxChunkedWriterODS(OAuthEndpointCredential credential) {
