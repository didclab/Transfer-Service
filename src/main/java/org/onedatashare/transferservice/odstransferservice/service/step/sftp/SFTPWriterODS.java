...
public class SFTPWriterODS extends ODSBaseWriter implements ItemWriter<DataChunk>, SetPool {

    private final int pipeSize;
    Logger logger = LoggerFactory.getLogger(SFTPWriterODS.class);
    ...
    public SFTPWriterODS(AccountEndpointCredential destCred, int pipeSize) {
